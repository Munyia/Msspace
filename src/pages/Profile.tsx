...
const Profile = () => {
  return (
    <div className="bg-[#DFDDE5] scrollbar-hide gap-5 overflow-y-auto flex flex-col md:flex-row justify-between rounded-3xl p-4 md:p-0">
      <div className="py-10 w-full md:w-[35%] flex flex-col items-center gap-3">
        ...
        <div className="w-full bg-white rounded-lg p-4 px-5 flex flex-col gap-2">
      ...
      <div className="flex py-10 w-full md:w-[65%]">
        <div className="bg-white rounded-2xl w-full">
          ...
          <div className="px-6 md:px-10 py-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
              {user.skills.map((skill, index) => (
                <div key={index} className="flex items-center flex-col p-3 text-sm py-5 rounded-lg shadow-md text-white" style={{ backgroundColor: skill.bgColor }}>
          ...
          <div className="flex flex-col md:flex-row justify-between px-6 md:px-10 py-5 gap-4 w-full">
            <div className="flex flex-col w-full md:w-1/2">
              ...
              <div className="flex text-sm flex-col gap-3">
                {['Food Safety', 'Risk Management and Assessment', 'Performance Management'].map((item, index) => (
                  <div key={index} className="bg-[#ECEAF2] py-3 gap-10 px-4 flex w-full rounded-3xl">
                    <img src={scope} alt="" />
                    <p>{item}</p>
                  </div>
                ))}
            ...
            <div className="flex flex-col w-full md:w-1/2">
              ...
              <div className="flex text-base flex-col gap-3">
                {[...Array(3)].map((_, index) => (
                  <div key={index} className="py-3 gap-2 px-4 flex w-full">
                    <img src={last} alt="" />
